...
export default function ManagementMeeting({ onBack }: { onBack: () => void }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch('/api/generate/management-meeting', {
                method: 'POST',
                body: formData,
            })
    ...
    return <BaseMeeting title="Management Meeting" formInitialState={form} errorsInitialState={errors} handleChange={handleChange} handleFile={handleFile} handleSubmit={handleSubmit} loading={loading} errors={errors} additionalFields={[additionalFields]} onBack={onBack} />
}
